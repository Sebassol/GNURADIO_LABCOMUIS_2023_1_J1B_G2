...
class labcomu1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Primer Fluograma", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Primer Fluograma")
        ...
        self.settings = Qt.QSettings("GNU Radio", "labcomu1")
        ...
        self._frecuencia_range = Range(-samp_rate/2, samp_rate/2, 100, 0, 200)
        ...
        self._Amplitud_range = Range(0.1, 5, 0.1, 1, 200)
