...
# Title: Lab1_punto2 Muestreo
# Author: MANUEL_SOLANO__FABIAN_JIMENEZ_J1B_GRUPO2
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto2 Muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto2 Muestreo")
        ...
        self._freq_range = Range(1k, 40k, 1k, 2k, 200)
